...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        // Note: ResourceQuota thread limiting removed — it causes ResourceExhausted
        // errors at high concurrency. gRPC's internal thread management + the connection
        // pool (512 readers) are sufficient to prevent unbounded thread growth.
